...
<body class=" bg-slate-50">
    ...
    <div class=" max-w-7xl mx-auto my-10">
        ...
        <div class="w-full mx-auto flex-wrap mt-8 flex items-center justify-around  gap-4 ">

            @foreach ($venues->take(3) as $venue)


            <div style="width: 24%" class="rounded-md   overflow p-4  shadow-lg overflow-hidden ">
                <img class=" object-cover w-80 h-44 rounded" src="https://image.wedmegood.com/resized/450X/uploads/member/506502/1548761884_5.jpeg" alt="">
                <h1>{{$venue->name}}</h1>
    ...
    <div class=" bg-sky-100 p-4 w-8/12 mx-auto my-14">
    ...
    <footer class="bg-pink-100 dark:bg-gray-900">
    ...
    <div class="px-4 py-6 bg-pink-200 w-full dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Venue Vault</a>. All Rights Reserved.
        </span>
