...
<div class="flex fixed z-10 xl:relative sidebar flex-col xl:w-72 max-h-max   pb-8 bg-pink-700 border-r  ">

    <a class="border-b-2 border-white flex items-center gap-4 w-full p-4  text-white bg-pink-800">
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <nav>
                ...
                <a class="flex mt-4 items-center px-4 mx-2 py-2  text-white  rounded-md  " href="{{route('event.index')}}">
                    ...
                    <a class="flex items-center px-4 mx-2 py-2 mt-5 text-white transition-colors duration-300 transform rounded-md  hover:bg-gray-200 -700 -200 hover:text-gray-700" href="{{route('venue.home')}}">
