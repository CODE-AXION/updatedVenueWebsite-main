        ...
        <div class="min-h-screen bg-gray-100 flex">
            ...
            <section class="w-9/12 px-4 mx-auto ">
                <div class="flex items-center gap-x-3 mt-16">
                    <h2 class="text-lg font-medium text-gray-800 dark:text-white">Events</h2>

                    <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">{{$events->count()}} Events</span>
                    
                    <div class="ml-auto px-3 py-1  text-blue-600 bg-blue-100 rounded-md">
                        <a href="{{route('event.create')}}">Event Create</a>
                    </div>
                </div>
                                ...
                                <table id="eventstable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{$event->name}}</td>
                                            ...
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <div class="flex items-center gap-x-6">
                                                    ...
                                                    <a href="{{route('event.edit',$event->id)}}" class="block text-gray-500 transition-colors duration-200 dark:hover:text-yellow-500 dark:text-gray-300 hover:text-yellow-500 focus:outline-none">
