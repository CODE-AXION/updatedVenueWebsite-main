        ...
        <div class="min-h-screen bg-gray-100 flex">
            ...
            <section class="w-9/12 px-4 mx-auto ">
                <div class="flex items-center gap-x-3 mt-16">
                    <h2 class="text-lg font-medium text-gray-800 ">Locations</h2>

                    <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full ">{{$locations->count()}} Categories</span>
                                ...
                                <table id="categoriestable" class="min-w-full divide-y divide-gray-200 ">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200 ">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{{$location->name}}</td>
                                            ...
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <div class="flex items-center gap-x-6">
                                                    ...
                                                    <a href="{{route('location.edit',$location->id)}}" class="block text-gray-500 transition-colors duration-200  hover:text-yellow-500 focus:outline-none">
