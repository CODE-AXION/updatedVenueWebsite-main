        ...
        <div class="min-h-screen bg-gray-100 flex">
            ...
            <section class="w-9/12 px-4 mx-auto ">
                <div class="flex items-center gap-x-3 mt-16">
                    ...
                    <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full ">{{$venues->count()}} Venues</span>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200 ">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">
                                                <img class="w-80" src="{{asset($venue->image)}}" alt="">
                                            </td>

                                            <td class="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{{$venue->name}}</td>
                                            <td class="px-4 py-4 text-sm text-gray-500  whitespace-nowrap"> {{$venue->services->count()}} </td>

                                            <td class="px-4 py-4 text-sm text-gray-500  whitespace-nowrap"> {{$venue->event->name}} </td>

                                            <td class="px-4 py-4 text-sm text-gray-500  whitespace-nowrap"> {{$venue->category->name}} </td>
                                            <td class="px-4 py-4 text-sm text-gray-500  whitespace-nowrap"> {{$venue->location->name}} </td>
                                            ...
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <div class="flex items-center gap-x-6">
                                                    ...
                                                    <a href="{{route('venue.edit',$venue->id)}}" class="block text-gray-500 transition-colors duration-200  hover:text-yellow-500 focus:outline-none">
