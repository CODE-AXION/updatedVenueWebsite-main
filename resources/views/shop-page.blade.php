...
<body class=" bg-slate-50">
    ...
    <div class="w-10/12 mt-16 mx-auto">
        ...
        <div class="flex gap-8  justify-between w-full flex-col-reverse lg:flex-row-reverse">
            <div class="w-full">
            ...
            <div class="mt-8 w-full lg:w-3/12">
                <h1 class="text-xl text-center lg:text-left text-pink-500 font-semibold">Venues By Type</h1>
                
                <div class="flex justify-center flex-wrap gap-4 lg:block w-full">
                ...
                <h1 class="text-xl mt-8  text-center lg:text-left text-pink-500 font-semibold">Venues By Categories</h1>
                ...
                <h1 class="text-xl mt-8  text-center lg:text-left text-pink-500 font-semibold">Venues By Locations</h1>
